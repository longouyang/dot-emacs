...
TODO: switch to use-package and figure out if i need helm-config these days
...
(use-package ess
  ...
  :mode ("\\.R\\'" . R-mode)
  :config
  ; (ess-toggle-underscore nil) ; TODO(25-03-08): get this working again on a fresh machine
...
org-drill stuff requires org-plus-contrib package
...
;; TODO: fix this to new solarized package 2025. also maybe switch to straight.el
